...
return(false);
	...
	<body>
		...
		<form action="newshop.php" name="form1" onSubmit="return abc()" method="POST">  
...
<tr><td>Password</td><td><input type="password" name="password" id="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="must contain atleast one number and one uppercase ,one lowercase ,atleast 8 or more characters" requied/></td></tr>
<tr><td>Shop Reg No</td><td><input type="text" name="shopreg" id="shopreg"></td></tr>
<tr><td>Shop Owner</td><td><input type="text" name="shopowner" id="shopowner"></td></tr>
